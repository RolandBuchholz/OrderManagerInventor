using Inventor;
using OrderInvAddin.Addin;
using System;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;
using System.Windows.Interop;

namespace OrderInvAddin
{
    /// <summary>
    ...
    /// </summary>
    [ProgId("OrderInvAddin.StandardAddinServer")]
    ...
    public class StandardAddInServer : Inventor.ApplicationAddInServer
    {
        ...
        public void Activate(ApplicationAddInSite addInSiteObject, bool firstTime)
        {
            try
            {
                ...
                Button01 = create_button("Auftrags"+ System.Environment.NewLine +"Bearbeitung", "id_OrderManager", @"Resources\Buttons\OrderManager");
        ...
        private void AddToUserInterface()
        {
            ...
            RibbonTab BeTab_asm;
            BeTab_asm = setup_tab("Tools", "id_TabAssemble", asmRibbon);

            // Set up Panels.
            // panel = setup_panel(display_name, internal_name, ribbon_tab)

            RibbonPanel BeToolsPanel;
            BeToolsPanel = setup_panel("BE Tools", "id_TabAssemble", BeTab_asm);
            ...
            if (!(Button01 == null))
            {
                BeToolsPanel.CommandControls.AddButton(Button01, true);
            }
        }
